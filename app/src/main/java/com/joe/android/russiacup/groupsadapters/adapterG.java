...
import com.joe.android.russiacup.models.G;
...
public class adapterG extends RecyclerView.Adapter<adapterG.viewholder> {

    Context context;
    Call<Groups> mycall;
    List<G> myateams=new ArrayList<>();

    public adapterG(Context contextt)
    {
        ...
        mycall.enqueue(new Callback<Groups>() {
            ...
            public void onResponse(Call<Groups> call, Response<Groups> response) {
                ...
                myateams=response.body().getStandings().getG();
